...
@Component
public class SearchEmployeesByProjectList implements Input {
    private final AnswerConsumerImpl answerConsumer;
    private final EmployeeService employeeService;
    private final SubmittingAdditionalMessage message;
    @Autowired
    public SearchEmployeesByProjectList(AnswerConsumerImpl answerConsumer, EmployeeService employeeService,
