...
@Component
public class SearchEmployeesByPosition implements Input {
    private final AnswerConsumerImpl answerConsumer;
    private final EmployeeService employeeService;
    private final SubmittingAdditionalMessage message;
    @Autowired
    public SearchEmployeesByPosition(AnswerConsumerImpl answerConsumer, EmployeeService employeeService,
    ...
    public void handle(Update update) {
        ...
        try {
            List<Employee> listEmployView = employeeService.searchEmployeeByPosition(messageText);
