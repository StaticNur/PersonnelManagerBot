...
@Component
public class ChangeLastNameChooseCallback implements CallbackHandler{
    @Override
    public SendMessage apply(Callback callback, Update update) {
        ...
        StateForEmployeeData.stateAndCard.put(BotInputState.WAITING_FOR_EMPLOYEE_DATA_FOR_EDIT_LAST_NAME, stateForEmployeeData.getValue());

        return new SendMessage(chatId.toString(), "Введите фамилию:");
    }
}
